...
namespace Tests.Updates
{
	...
	public class UnderstandingUpdateDocuments : DemoTests
	{
		...
		{
			var update = Update.Set("Age", 54);//untyped version
		...
		public void TypedUpdateStatic()
		{
            ...
            Console.WriteLine(update);
            Console.WriteLine(update2.Render(BsonSerializer.SerializerRegistry.GetSerializer<Person>(), BsonSerializer.SerializerRegistry));
        }
